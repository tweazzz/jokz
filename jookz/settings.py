"""
Django settings for jookz project.
...
SECRET_KEY = 'django-insecure-yzkqe1shdf3a3q(#2zeum_=mb)f-0r^kd1gjz@)o5&k_g)&#5u'
...
# AUTH
AUTH_USER_MODEL = 'prof.User'
AUTHENTICATION_BACKENDS = ['prof.backends.EmailOrUsernameModelBackend']
...
WSGI_APPLICATION = 'jookz.wsgi.application'
